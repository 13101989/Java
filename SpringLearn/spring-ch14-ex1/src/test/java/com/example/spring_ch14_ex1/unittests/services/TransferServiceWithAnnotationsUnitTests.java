package com.example.spring_ch14_ex1.unittests.services;
...
public class TransferServiceWithAnnotationsUnitTests {
    ...
    @Test
    @DisplayName("Test the amount is transferred from one account to another if no exception occurs with annotations")
    ...
    @Test
    @DisplayName("Test the amount is not transferred if the destination account is not found")
    public void moneyTransferDestinationAccountNotFoundFlow() {
        ...
        assertThrows(
                AccountNotFounfException.class,
                () -> transferService.transferMoney(
                        1,
                        2,
                        new BigDecimal(100)
